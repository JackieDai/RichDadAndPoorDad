...
> 表示 按计划、按时间表 或 按照正常顺序**应该发生**或**实现某事**
...
> 作为名词：
>
> 1. **夹子，夹住的部分：** "Pinch" 可以指夹子或夹住的部分。例如：
